...
def eva_model(image):
    ...
    clf = joblib.load('./model_use/SVC.model')
...
if __name__ == '__main__':
    ...
    file=['./datasets/base_emotion/00.JPG','./datasets/base_emotion/0.JPG','./datasets/base_emotion/1.JPG','./datasets/base_emotion/2.JPG','./datasets/base_emotion/3.JPG','./datasets/base_emotion/4.JPG','./datasets/base_emotion/5.JPG','./datasets/base_emotion/6.JPG','./datasets/base_emotion/7.JPG']
